 ...
 * 
 */
@WebServiceClient(name = "Info", targetNamespace = "http://footballpool.dataaccess.eu", wsdlLocation = "META-INF/wsdl/Info.wsdl")
public class Info
    extends Service
{
    ...
    static {
        INFO_WSDL_LOCATION = eu.dataaccess.footballpool.Info.class.getClassLoader().getResource("META-INF/wsdl/Info.wsdl");
        WebServiceException e = null;
        if (INFO_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/Info.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
        INFO_EXCEPTION = e;
    }
