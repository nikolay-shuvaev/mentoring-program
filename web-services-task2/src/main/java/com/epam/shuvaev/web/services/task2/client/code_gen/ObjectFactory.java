 ...
 * generated in the com.epam.shuvaev.web.services.task2.client.code_gen package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValue_QNAME = new QName("http://service.task2.services.web.shuvaev.epam.com/", "getValue");
    private final static QName _GetValueResponse_QNAME = new QName("http://service.task2.services.web.shuvaev.epam.com/", "getValueResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.epam.shuvaev.web.services.task2.client.code_gen
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.task2.services.web.shuvaev.epam.com/", name = "getValue")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.task2.services.web.shuvaev.epam.com/", name = "getValueResponse")
